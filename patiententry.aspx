<%@ Page Language="C#" AutoEventWireup="true" CodeFile="patiententry.aspx.cs" Inherits="patiententry" %>
...
<body background="images/bgs.jpeg">
    ...
    <table style="position:absolute; top: 240px; left: 307px; width: 542px;">
    <tr>
    <td>
    ...
    <td class="style2">
        ...
        <asp:Label ID="Label1" runat="server" Font-Names="Bauhaus 93" 
            Font-Size="Larger" ForeColor="White" Text="Patient Details Entry"></asp:Label>
    ...
    <td class="style2">
        ...
        <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TextBox1" PopupButtonID="TextBox1">
        </cc1:CalendarExtender>
        <asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
        <%--<cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TextBox1" PopupButtonID="TextBox1">
        </cc1:CalendarExtender>--%>
    ...
    <td class="style2">
        ...
        <asp:TextBox ID="TextBox9" runat="server" BackColor="#EAFFFF" 
            BorderColor="#9900CC" BorderStyle="Solid" BorderWidth="2px" Height="23px" 
            Width="188px"></asp:TextBox>
        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBox9" PopupButtonID="TextBox9">
        </cc1:CalendarExtender>
    ...
    <td class="style2">
        ...
        <asp:Button ID="Button1" runat="server" BackColor="#006666" 
            BorderColor="#006666" BorderStyle="Solid" BorderWidth="2px" Font-Bold="True" 
            Font-Names="Corbel" Font-Size="Large" ForeColor="White" Height="26px" 
            Text="Add" Width="69px" onclick="Button1_Click" />
