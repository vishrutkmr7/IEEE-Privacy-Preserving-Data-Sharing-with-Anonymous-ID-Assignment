<%@ Page Language="C#" AutoEventWireup="true" CodeFile="patientview.aspx.cs" Inherits="patientview" %>
...
<body background="images/bgs.jpeg">
   ...
   <table style="position:absolute; top: 231px; left: 405px; width: 459px; height: 601px;">
   <tr>
   <td align="center" colspan="2">
   
       <asp:Label ID="Label1" runat="server" Font-Names="Bauhaus 93" 
           Font-Size="Larger" ForeColor="White" Text="User Details"></asp:Label>
   ...
   <td>
       ...
       <asp:TextBox ID="TextBox8" runat="server" BackColor="#CCFFCC" 
           BorderColor="#009933" BorderStyle="Solid" BorderWidth="2px" Height="30px" 
           Width="204px"></asp:TextBox>
       <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="TextBox8" TargetControlID="TextBox8">
