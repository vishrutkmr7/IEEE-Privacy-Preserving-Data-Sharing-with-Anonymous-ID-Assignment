...
public partial class patientedit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("select * from patientdetails where dname='" + (string)Session["nam"]+ "'", con);
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlDataAdapter sda1 = new SqlDataAdapter("select * from patientdetails where pid='" + DropDownList1.SelectedItem.Text + "' and dname='" + (string)Session["nam"] + "'", con);
            DataSet ds1 = new DataSet();
            sda1.Fill(ds1);
            if (ds1.Tables[0].Rows.Count > 0)
            {
                Label3.Text = ds1.Tables[0].Rows[0]["did"].ToString();
                CheckBox1.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup1"].ToString());
                Label5.Text = ds1.Tables[0].Rows[0]["dname"].ToString();
                CheckBox2.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup2"].ToString());
                Label8.Text = ds1.Tables[0].Rows[0]["pname"].ToString();
                CheckBox4.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup4"].ToString());
                TextBox1.Text = ds1.Tables[0].Rows[0]["admdate"].ToString();
                CheckBox5.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup5"].ToString());
                TextBox2.Text = ds1.Tables[0].Rows[0]["disease"].ToString();
                CheckBox6.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup6"].ToString());
                TextBox3.Text = ds1.Tables[0].Rows[0]["ecg"].ToString();
                CheckBox7.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup7"].ToString());
                TextBox4.Text = ds1.Tables[0].Rows[0]["scan"].ToString();
                CheckBox8.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup8"].ToString());
                TextBox5.Text = ds1.Tables[0].Rows[0]["xray"].ToString();
                CheckBox9.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup9"].ToString());
                TextBox6.Text = ds1.Tables[0].Rows[0]["urine"].ToString();
                CheckBox10.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup10"].ToString());
                TextBox7.Text = ds1.Tables[0].Rows[0]["blood"].ToString();
                CheckBox11.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup11"].ToString());
                TextBox8.Text = ds1.Tables[0].Rows[0]["health"].ToString();
                CheckBox12.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup12"].ToString());
                TextBox9.Text = ds1.Tables[0].Rows[0]["disdate"].ToString();
                CheckBox13.Checked = Convert.ToBoolean(ds1.Tables[0].Rows[0]["sup13"].ToString());
            }
            else
            {
                RegisterStartupScript("msg", "<script>alert('No Patient Details are Available...')</script>");
            }
            con.Close();
        }
    }
    ...
    {
        con.Open();
        SqlCommand com = new SqlCommand("update patientdetails set did='" + Label3.Text + "', sup1='" + CheckBox1.Checked + "',dname='" + Label5.Text + "', sup2='" + CheckBox2.Checked + "',pid='" + DropDownList1.SelectedItem.Text + "', sup3='" + CheckBox3.Checked + "',pname='" + Label8.Text + "', sup4='" + CheckBox4.Checked + "',admdate='" + TextBox1.Text + "', sup5='" + CheckBox5.Checked + "',disease='" + TextBox2.Text + "', sup6='" + CheckBox6.Checked + "',ecg='" + TextBox3.Text + "', sup7='" + CheckBox7.Checked + "',scan='" + TextBox4.Text + "', sup8='" + CheckBox8.Checked + "',xray='" + TextBox5.Text + "', sup9='" + CheckBox9.Checked + "',urine='" + TextBox6.Text + "', sup10='" + CheckBox10.Checked + "',blood='" + TextBox7.Text + "', sup11='" + CheckBox11.Checked + "',health='" + TextBox8.Text + "', sup12='" + CheckBox12.Checked + "',disdate='" + TextBox9.Text + "', sup13='" + CheckBox13.Checked + "' where pid='" + DropDownList1.SelectedItem.Text + "'", con);
        com.ExecuteNonQuery();
        RegisterStartupScript("msg", "<script>alert('Patient Details Updated Successfully...')</script>");
        con.Close();
    }
